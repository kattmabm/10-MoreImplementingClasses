...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clones = 0
        self.initial.start = self.start
        self.initial.end = self.end
    ...
    def is_parallel(self, line2):
        ...
        slope_self = round(self.slope(), 10)
        slope_line = round(line2.slope(), 10)
        return slope_self == slope_line
